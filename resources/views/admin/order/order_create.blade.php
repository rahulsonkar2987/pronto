                        ...
                        <form  id='FormData' method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row mx-4">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" name="coupon_name"  class="form-control" placeholder="{{ ln('coupon_name','ucwords') }}">
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                              ...
                              <input type="text" name="discount"  class="form-control" placeholder="{{ ln('discount','ucwords') }}" >
                            </div>

                            <div class="form-group col-lg-6">
                              <label for="restaurant_deduction ">{{ ln('restaurant_deduction (%)','ucwords') }}</label>
                              <input type="text" name="restaurant_deduction"  class="form-control" placeholder="{{ ln('restaurant_deduction ','ucwords') }}" >
                            </div>

                            <div class="form-group col-lg-6">
                              <label for="start_time ">{{ ln('start_time ','ucwords') }}</label>
                              <input type="datetime-local" name="start_time"  class="form-control" placeholder="{{ ln('start_time ','ucwords') }}" >
                            </div>

                            <div class="form-group col-lg-6">
                              <label for="end_time ">{{ ln('end_time ','ucwords') }}</label>
                              <input type="datetime-local" name="end_time"  class="form-control" placeholder="{{ ln('end_time ','ucwords') }}" >
                            </div>
